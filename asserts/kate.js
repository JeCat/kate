(function(window){
	...
	KateHtmlWindow.prototype.show = function()
	{
	...
	KateHtmlWindow.prototype.width = function()
	{
		return kateapi.width(this.wndId) ;
	}
	KateHtmlWindow.prototype.height = function()
	{
		return kateapi.height(this.wndId) ;
	}
	KateHtmlWindow.prototype.inspector = function()
	{
		return kateapi.inspector(this.wndId) ;
	}
	KateHtmlWindow.prototype.setFlags = function(flags)
	{
		return kateapi.setWindowFlags(this.wndId,flags) ;
	}
	KateHtmlWindow.prototype.flags = function()
	{
		return kateapi.windowFlags(this.wndId) ;
	}
